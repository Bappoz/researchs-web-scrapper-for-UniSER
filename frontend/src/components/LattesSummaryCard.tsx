...
const LattesSummaryCard: React.FC<LattesSummaryCardProps> = ({
  data,
  loading = false,
}) => {
  // Se está carregando
  ...
  return (
    <div className='bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 shadow-md'>
      ...
      <div className='space-y-3'>
        ...
        {/* Instituição */}
        {data.institution &&
          data.institution !== "Instituição não informada" && (
            <div>
      ...
      <div className='mt-4 pt-3 border-t border-blue-200'>
        <p className='text-xs text-gray-600 italic'>
          ℹ️ Informações obtidas através do Escavador, que agrega dados da
          Plataforma Lattes
        </p>
      </div>
    </div>
